...
function saveState() {
	if (Modernizr.localstorage) {
		...
		localStorage.setItem("masterState", JSON.stringify(masterState) /*LZString.compress(JSON.stringify(masterState))*/);
...
function loadState() {
	if (Modernizr.localstorage) {
		if (hasSavedGameState()) {
	 		var m = localStorage.getItem("masterState"); /*JSON.parse(LZString.decompress(localStorage.getItem("masterState")));*/
