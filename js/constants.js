...
var constants = {
	...
	INVENTORY_TABLE : "<tr><th colspan=\"4\" width=\"100\">Inventory</th><th width=\"100\">Ground</th></tr><tr><td>Weight:</td><td>%INVENTORY_WEIGHT%</td><td>/</td><td>%PLAYER_CAPACITY%</td><td>&nbsp;</td></tr>",
	PLAYER_INVENTORY_ROW : "<tr><td colspan=\"4\"><a title=\"Weight: %ITEM_WEIGHT%\" class=\"tooltip\"><button>%ITEM_NAME% (%ITEM_QUANTITY%)</button></a></td>",
	BLANK_PLAYER_INVENTORY_ROW : "<tr><td colspan=\"4\">&nbsp;</td>",
	LOCATION_INVENTORY_ROW : "<td style=\"text-align:right\"><button>%ITEM_NAME% (%ITEM_QUANTITY%)</button></td></tr>",
